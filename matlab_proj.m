...
interface=figure;
global shape color_number start grade pause_time last_speed
grade=0;
global type1_1 type1_2 type1_3 type1_4 type2_1 type2_2 type3_1 type3_2 type4_1 type5_1 type5_2 type6_1 type6_2
global type7_1 type7_2 type5_3 type5_4 type6_3 type6_4 game_over pause1
game_over=0;
type=zeros(3,3);
type(2,2)=1;
type1_1=type;
...
shape=type;
    ...
    function ai
        ...
        for i7 = 1:max_column-2
            ...
            if(h1==h2&&h2==h3&&h1<flat_p)
                flat=i7+1;
                flat_p=h1;
            end
            if(h1==h2+1&&h2==h3&&h2<left_high_flat_p)
                left_high_flat=i7+1;
                left_high_flat_p=h2;
            end
            if(h1==h2+1&&left_high_p>h2)
                left_high=i7;
                left_high_p=h2;
            end
            if(h2==h3+1&&left_high_p>h3)
                left_high=i7+1;
                left_high_p=h2;
            end
            
            if(h1==h2&&h2==h3-1&&h2<right_high_flat_p)
                right_high_flat=i7+1;
                right_high_flat_p=h2;
            end
            if(h1==h2-1&&right_high_p>h2)
                right_high=i7+1;
                right_high_p=h2;
            end
            if(h2==h3-1&&right_high_p>h3)
                right_high=i7+2;
                right_high_p=h3;
            end
            if(h1==h3&&h1==h2+1&&low_middle_p>h2)
                low_middle=i7+1;
                low_middle_p=h2;
            end
            if(h2>=h1+3&&high_three_p>h1)
            high_three=i7;
                high_three_p=h1;
            end
            if(h3>=h2+3&&high_three_p>h2)
            high_three=i7+1;
                high_three_p=h2;
            end
            if((h1>=h2+3)&&high_three_p>h2)
                high_three=i7+1;
                high_three_p=h2;
            end
            if((h2>=h3+3)&&high_three_p>h3)
                high_three=i7+2;
                high_three_p=h3;
            end
            if((h1==h2+2||h3==h2+2)&&high_two_p>h2)
                high_two=i7+1;
                high_two_p=h2;
            end
            if(h1==h2+2&&high_two_left_p>h2)
                high_two_left=i7+1;
                high_two_left_p=h2;
            end
            if(h2==h3+2&&high_two_left_p>h3)
                high_two_left=i7+2;
                high_two_left_p=h3;
            end
            if(h1==h2-2&&high_two_right_p>h1)
                high_two_right=i7;
                high_two_right_p=h1;
            end
            if(h2==h3-2&&high_two_right_p>h2)
                high_two_right=i7+1;
                high_two_right_p=h2;
            end
            if(h1==h2&&flat_two_p>h2)
                flat_two=i7+1;
                flat_two_p=h2;
            end
            if(h3==h2&&flat_two_p>h3)
                flat_two=i7+2;
                flat_two_p=h3;
            end
        end
...
function  is_reach
global plane shape row  col max_row max_column grade game_over
flag=0;
for i =1:3
    if(flag==1)
    break;
